...
def main(args):
    # init logger
    if args.mode == "train":
        log_path = args.log_path + "train_unbiased_model2.log"
    elif args.mode == "test":
    ...
    with open(args.test_results, 'w') as f:
        best_macro_f1 = 0.0
        for constraint_loss_weight in [0.001, 0.002, 0.004, 0.006, 0.008, 0.01]:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", type=str, default="./models/unbiased_model_best2.pth")
