...
def main(args):
    ...
    if args.mode == "train":
        log_path = log_path + "{}_CHEF_dual_unbiased_emplify_bias_cc_{}_ce_{}_claim_{}_evidence_{}_scaled_{}.log".format(args.num_classes, args.constraint_claim_loss_weight, args.constraint_evidence_loss_weight, args.claim_loss_weight, args.evidence_loss_weight, args.scaled_rate)
    elif args.mode == "test":
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", type=str, default="./models/two_dual_unbiased_emplify_CHEF_[CC]_[CE]_[claim]_[evidence]_[scaled].pth")
