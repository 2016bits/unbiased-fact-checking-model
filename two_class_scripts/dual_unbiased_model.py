...
def main(args):
    ...
    if args.mode == "train":
        log_path = log_path + "{}_class_CHEF_dual_unbiased_cc_{}_ce_{}_claim_{}_evidence_{}.log".format(args.num_classes, args.constraint_claim_loss_weight, args.constraint_evidence_loss_weight, args.claim_loss_weight, args.evidence_loss_weight)
    elif args.mode == "test":
        log_path = log_path + "test_two_class_CHEF_dual_unbiased_model.log"
