...
prompt = """根据证据判断给定声明的真实性：SUPPORTS表示证据支持声明，REFUTES表示证据反驳声明
声明: [CLAIM]
证据: [EVIDENCE]
标签: 。
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("使用ChatGPT测试在CHEF上二分类效果")
    # parser.add_argument("--log_path", type=str, default="./logs/chatgpt_CHEF_two_class.log")
    # parser.add_argument("--data_path", type=str, default="./data/processed/test_2.json")
    # parser.add_argument("--out_path", type=str, default="./results/verify_CHEF_two_class_with_chatgpt.json")
    # parser.add_argument("--tmp_path", type=str, default="./tmp/chatgpt_CHEF_two_class2.txt")

    parser.add_argument("--log_path", type=str, default="./logs/chatgpt_improved_CHEF_two_class.log")
