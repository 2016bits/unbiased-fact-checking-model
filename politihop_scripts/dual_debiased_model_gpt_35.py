...
def main(args):
    ...
    if args.mode == "train":
        ...
        log_path = log_path + "{}_gpt_35_constraint_{}_claim_{}_scaled_{}.log".format(args.num_classes, args.constraint_loss_weight, args.claim_loss_weight, args.scaled_rate)
    elif args.mode == "test":
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_path", type=str, default='./save_logs/hard-PolitiHop/gpt35/')
    ...
    parser.add_argument("--test_data_path", type=str, default="./data/hard-PolitiHop/converted_data/test_gpt35_3.json")
    ...
    parser.add_argument("--saved_model_path", type=str, default="./save_models/hard-PolitiHop/politihop_gpt35.pth")
