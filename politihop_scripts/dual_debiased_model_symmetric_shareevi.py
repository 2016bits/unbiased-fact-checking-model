...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_path", type=str, default='./save_logs/[DATASET]_shareevi/para/')
    ...
    parser.add_argument("--saved_model_path", type=str, default="./save_models/[DATASET]/symmetric_shareevi.pth")

    parser.add_argument("--test_results", type=str, default="./para_results/symmetric_politihop_shareevi.txt")
