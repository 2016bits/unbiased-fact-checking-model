...
def main(args):
    ...
    if args.mode == "train":
        ...
        log_path = log_path + "{}_adv_constraint_{}_claim_{}_scaled_{}.log".format(args.num_classes, args.constraint_loss_weight, args.claim_loss_weight, args.scaled_rate)
    elif args.mode == "test":
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_path", type=str, default='./save_logs/hard-PolitiHop/[DATA]_')
    ...
    parser.add_argument("--test_data_path", type=str, default="./data/hard-PolitiHop/converted_data/test_[DATA]_3.json")
