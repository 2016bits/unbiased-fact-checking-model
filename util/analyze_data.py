...
if __name__ == '__main__':
    ...
    # for dual unbias
    parser.add_argument("--in_path", type=str, default='para_results/3_CHEF_two_class_dual_unbiased.txt')
    parser.add_argument("--out_path", type=str, default='./results/two_CHEF_dual_unbiased.xlsx')
