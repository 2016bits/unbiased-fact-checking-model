...
from util.model import Unbiased_wo_ce
...
def main(args):
    ...
    if args.mode == "train":
        log_path = log_path + "unbiased_wo_ce.log"
    elif args.mode == "test":
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", type=str, default="./ablation/models/unbiased_wo_ce.pth")
