...
from util.model import Unbiased_wo_claim
...
def train(args, model, train_loader, dev_loader, logger):
    ...
    for epoch in range(args.epoch_num):
        ...
        for i, (claim_ids, claim_msks, evidence_ids, evidence_msks, ce_ids, ce_msks, labels) in tqdm(enumerate(train_loader),
            ...
            out_e, out_ce = model(evidence_ids, evidence_msks, ce_ids, ce_msks)
            ...
            loss = loss_ce.sum() + args.evidence_loss_weight * loss_e.sum()
        ...
        for i, (claim_ids, claim_msks, evidence_ids, evidence_msks, ce_ids, ce_msks, labels) in tqdm(enumerate(dev_loader),
            ...
            with torch.no_grad():
                ...
                scores = prob_ce - scaled_prob_e * args.evidence_loss_weight
...
def main(args):
    ...
    if args.mode == "train":
        log_path = log_path + "unbiased_model_wo_claim_evidence_{}.log".format(args.evidence_loss_weight)
    elif args.mode == "test":
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", type=str, default="./ablation/models/unbiased_wo_claim_[evidence].pth")
