...
def main(args):
    ...
    # for CHEF
    # if args.mode == "train":
    #     log_path = args.log_path + "train_claim_only_{}.log".format(args.num_classes)
    # elif args.mode == "test":
    #     log_path = args.log_path + "test_claim_only_{}.log".format(args.num_classes)
    # for symmetric-CHEF
    if args.mode == "train":
        log_path = args.log_path + "train_claim_only_symmetric_{}.log".format(args.num_classes)
    elif args.mode == "test":
        log_path = args.log_path + "test_claim_only_symmetric_{}.log".format(args.num_classes)
    ...
    # train_raw = dataset.read_data(train_data_path, "only_claim")
    # dev_data_path = args.data_path.replace("[DATA]", "dev")
    # dev_raw = dataset.read_data(dev_data_path, "only_claim")
    # test_data_path = args.data_path.replace("[DATA]", "test")
    # test_raw = dataset.read_data(test_data_path, "only_claim")
    ...
    train_batched = dataset.batch_c_data(train_raw[:args.num_sample], args.max_len, tokenizer)
    dev_batched = dataset.batch_c_data(dev_raw[:args.num_sample], args.max_len, tokenizer)
    test_batched = dataset.batch_c_data(test_raw[:args.num_sample], args.max_len, tokenizer)
