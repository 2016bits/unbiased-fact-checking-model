...
from util.model import Unbiased_wo_evidence
...
def main(args):
    ...
    if args.mode == "train":
        log_path = log_path + "unbiased_model_wo_evidence_{}.log".format(args.claim_loss_weight)
    elif args.mode == "test":
    ...
    # load model
    model = Unbiased_wo_evidence(args)
    model = model.cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", type=str, default="./ablation/models/unbiased_wo_evidence_[claim].pth")
