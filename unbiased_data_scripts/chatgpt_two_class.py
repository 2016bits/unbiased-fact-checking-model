...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_path", type=str, default="./logs/chatgpt_two_class_symmetric.log")
    parser.add_argument("--data_path", type=str, default="./data/gpt/symmetric_test_2_all.json")
    parser.add_argument("--out_path", type=str, default="./results/verify_two_class_symmetric_with_chatgpt.json")
    parser.add_argument("--tmp_path", type=str, default="./tmp/chatgpt_two_class_symmetric2.txt")
