...
def main(args):
    # init logger
    log_path = args.log_path + "train_two_class_base_symmetric_data.log"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", type=str, default="./models/train_two_class_base_model.pth")
