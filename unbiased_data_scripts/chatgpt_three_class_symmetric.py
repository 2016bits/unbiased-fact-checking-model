...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("使用ChatGPT测试在symmetric_CHEF上三分类效果")
    parser.add_argument("--log_path", type=str, default="./logs/chatgpt_symmetric_CHEF_three_class.log")
    # parser.add_argument("--data_path", type=str, default="./data/gpt/symmetric_test_3_all_distilled.json")
    parser.add_argument("--data_path", type=str, default="./data/gpt/symmetric_test_3_all2.json")
    parser.add_argument("--out_path", type=str, default="./results/verify_symmetric_CHEF_three_class_with_chatgpt2.json")
    parser.add_argument("--tmp_path", type=str, default="./tmp/chatgpt_symmetric_CHEF_three_class.txt")
