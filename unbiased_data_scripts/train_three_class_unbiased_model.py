...
def main(args):
    ...
    if args.mode == "train":
        ...
        # for CHEF
        log_path = args.log_path + "symmetric_CHEF_{}_unbiased_constraint_{}_claim_{}.log".format(args.num_classes, args.constraint_loss_weight, args.claim_loss_weight)
    elif args.mode == "test":
        # for improved_CHEF
        # log_path = args.log_path + "test_unbiased_three_improved_CHEF_model.log"
        # for CHEF
        log_path = args.log_path + "test_unbiased_three_symmetric_CHEF_model.log"
...
if __name__ == '__main__':
    ...
    # for symmetric CHEF
    parser.add_argument("--train_dev_data_path", type=str, default="./data/gpt/symmetric_dev_3_all.json")
    parser.add_argument("--test_data_path", type=str, default="./data/gpt/symmetric_test_3_all2.json")
    parser.add_argument("--saved_model_path", type=str, default="./models/parameter/three_unbiased_symmetric_CHEF_[constraint]_[claim].pth")
    parser.add_argument("--test_results", type=str, default="./test_results/symmetric_CHEF_three_class_unbiased.txt")
