...
def main(args):
    # init logger
    if args.mode == "train":
        log_path = args.log_path + "train_three_class_base_symmetric.log"
    elif args.mode == "test":
        log_path = args.log_path + "test_three_class_base_symmetric.log"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", type=str, default="./models/three_base_symmetric_CHEF.pth")

    parser.add_argument("--cache_dir", type=str, default="./bert-base-chinese")
    parser.add_argument("--checkpoint", type=str, default="./models/three_base_symmetric_CHEF.pth")
