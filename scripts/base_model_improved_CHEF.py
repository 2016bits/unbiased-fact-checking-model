...
def main(args):
    # init logger
    if args.mode == "train":
        log_path = args.log_path + "train_base_on_improved_CHEF_3.log"
    elif args.mode == "test":
        log_path = args.log_path + "test_base_on_improved_CHEF_3.log"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", type=str, default="./models/base_model_improved_CHEF_3.pth")
