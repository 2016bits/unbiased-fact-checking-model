...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("使用ChatGPT测试在improved CHEF上三分类效果")
    parser.add_argument("--log_path", type=str, default="./logs/chatgpt_improved_CHEF_three_class.log")
    parser.add_argument("--data_path", type=str, default="./data/improved_CHEF_3/test.json")
    parser.add_argument("--out_path", type=str, default="./results/verify_improved_CHEF_three_class_with_chatgpt.json")
    parser.add_argument("--tmp_path", type=str, default="./tmp/chatgpt_improved_CHEF_three_class.txt")
